		...
		<el-dialog v-model="formVisible" :title="formTitle" width="50%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="护工姓名" prop="hugongxingming">
							<el-input class="list_inp" v-model="form.hugongxingming" placeholder="护工姓名"
								 type="text" 								:readonly="!isAdd||disabledForm.hugongxingming?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="老人账号" prop="laorenzhanghao">
							<el-select
								...
								placeholder="请选择老人账号"
								>
								<el-option v-for="(item,index) in laorenzhanghaoLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='hugongxingming'){
					form.value.hugongxingming = row[x];
					disabledForm.value.hugongxingming = true;
					continue;
				}
				if(x=='touxiang'){
