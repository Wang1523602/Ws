				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="内容" prop="neirong">
							<el-input class="list_inp" v-model="form.neirong" placeholder="内容"
								 type="text" 								:readonly="!isAdd||disabledForm.neirong?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="聊天时间" prop="liaotianshijian">
							<el-date-picker
								class="list_date"
								v-model="form.liaotianshijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.liaotianshijian?true:false"
								placeholder="请选择聊天时间" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.liaotianshijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='liaotianshijian'){
					form.value.liaotianshijian = row[x];
					disabledForm.value.liaotianshijian = true;
					continue;
				}
				if(x=='laorenzhanghao'){
